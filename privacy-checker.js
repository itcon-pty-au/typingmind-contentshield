...
(function () {
  ...
  function setupPrivacyButton() {
    // Find the container where other buttons are
    const targetContainer = document.querySelector(
      "div.inline-flex, div.flex-col"
    );
    if (!targetContainer) {
      console.error("Could not find target container for privacy button");
      return;
    }
    ...
    targetContainer.appendChild(privacyButton);
